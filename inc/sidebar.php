    ...
    <div class="side-menu animate-dropdown outer-bottom-xs">
        <div class="head"><i class="icon fa fa-align-justify fa-fw"></i> Categories</div>
            <nav class="yamm megamenu-horizontal">
                <ul class="nav">
                    <li> <a href="#"><i class="icon fa fa-shopping-bag"></i>Camera</a></li>
                    <li> <a href="#"><i class="icon fa fa-shopping-bag"></i>Desktops</a></li>
                    <li> <a href="#"><i class="icon fa fa-shopping-bag"></i>Pants</a></li>
                    <li> <a href="#"><i class="icon fa fa-shopping-bag"></i>Bags</a></li>
                    <li> <a href="#"><i class="icon fa fa-shopping-bag"></i>Hats</a></li>
                    <li> <a href="#"><i class="icon fa fa-shopping-bag"></i>Accessories</a></li>
